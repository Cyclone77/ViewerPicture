...
(function (factory) {
  ...
  Viewer.prototype = {
    ...
    build: function () {
      ...
      $prev = $viewer.find('.viewer-prev');
      $prev.addClass(!options.prev ? CLASS_HIDE : getResponsiveClass(options.prev));

      $next = $viewer.find('.viewer-next');
      $next.addClass(!options.next ? CLASS_HIDE : getResponsiveClass(options.next));
